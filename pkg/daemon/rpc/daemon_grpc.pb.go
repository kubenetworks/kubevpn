...
type DaemonClient interface {
	...
	ConnectFork(ctx context.Context, opts ...grpc.CallOption) (Daemon_ConnectForkClient, error)
	...
	Clone(ctx context.Context, opts ...grpc.CallOption) (Daemon_CloneClient, error)
	Remove(ctx context.Context, opts ...grpc.CallOption) (Daemon_RemoveClient, error)
...
func (c *daemonClient) ConnectFork(ctx context.Context, opts ...grpc.CallOption) (Daemon_ConnectForkClient, error) {
...
func (x *daemonConnectForkClient) Send(m *ConnectRequest) error {
	return x.ClientStream.SendMsg(m)
}
...
func (c *daemonClient) Clone(ctx context.Context, opts ...grpc.CallOption) (Daemon_CloneClient, error) {
...
func (x *daemonCloneClient) Send(m *CloneRequest) error {
	return x.ClientStream.SendMsg(m)
}
...
func (c *daemonClient) Remove(ctx context.Context, opts ...grpc.CallOption) (Daemon_RemoveClient, error) {
...
func (x *daemonRemoveClient) Send(m *RemoveRequest) error {
	return x.ClientStream.SendMsg(m)
}
...
type DaemonServer interface {
	...
	ConnectFork(Daemon_ConnectForkServer) error
	Disconnect(Daemon_DisconnectServer) error
	Proxy(Daemon_ProxyServer) error
	Leave(Daemon_LeaveServer) error
	Clone(Daemon_CloneServer) error
	Remove(Daemon_RemoveServer) error
...
func (UnimplementedDaemonServer) ConnectFork(Daemon_ConnectForkServer) error {
...
func (UnimplementedDaemonServer) Clone(Daemon_CloneServer) error {
	return status.Errorf(codes.Unimplemented, "method Clone not implemented")
}
func (UnimplementedDaemonServer) Remove(Daemon_RemoveServer) error {
...
func _Daemon_ConnectFork_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(DaemonServer).ConnectFork(&daemonConnectForkServer{stream})
}
...
func (x *daemonConnectForkServer) Recv() (*ConnectRequest, error) {
	m := new(ConnectRequest)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func _Daemon_Clone_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(DaemonServer).Clone(&daemonCloneServer{stream})
}

type Daemon_CloneServer interface {
	Send(*CloneResponse) error
	Recv() (*CloneRequest, error)
	grpc.ServerStream
}
...
func (x *daemonCloneServer) Recv() (*CloneRequest, error) {
	m := new(CloneRequest)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func _Daemon_Remove_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(DaemonServer).Remove(&daemonRemoveServer{stream})
}
...
func (x *daemonRemoveServer) Recv() (*RemoveRequest, error) {
	m := new(RemoveRequest)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
