...
const file_daemon_proto_rawDesc = "" +
	"\n" +
	"\fdaemon.proto\x12\x03rpc\"\xcd\x03\n" +
	...
	"\x10ManagerNamespace\x18\f \x01(\tR\x10ManagerNamespace\"+\n" +
	...
	"\amessage\x18\x01 \x01(\tR\amessage\"\xcf\x06\n" +
	"\fCloneRequest\x12(\n" +
	"\x0fKubeconfigBytes\x18\x01 \x01(\tR\x0fKubeconfigBytes\x12\x1c\n" +
	"\tNamespace\x18\x02 \x01(\tR\tNamespace\x128\n" +
	...
	"\x10TargetKubeconfig\x18\t \x01(\tR\x10TargetKubeconfig\x12(\n" +
	"\x0fTargetNamespace\x18\n" +
	" \x01(\tR\x0fTargetNamespace\x12(\n" +
	"\x0fTargetContainer\x18\v \x01(\tR\x0fTargetContainer\x12 \n" +
	"\vTargetImage\x18\f \x01(\tR\vTargetImage\x12&\n" +
	"\x0eTargetRegistry\x18\r \x01(\tR\x0eTargetRegistry\x126\n" +
	"\x16IsChangeTargetRegistry\x18\x0e \x01(\bR\x16IsChangeTargetRegistry\x12$\n" +
	...
	"\bmetadata\x18\x01 \x03(\tR\bmetadata\"6\n" +
	...
	"\x02ID\x18\x01 \x01(\tR\x02ID2\xe2\t\n" +
	"\x06Daemon\x128\n" +
	"\aConnect\x12\x13.rpc.ConnectRequest\x1a\x14.rpc.ConnectResponse\"\x000\x01\x12<\n" +
	"\vConnectFork\x12\x13.rpc.ConnectRequest\x1a\x14.rpc.ConnectResponse\"\x000\x01\x12A\n" +
	"\n" +
	"Disconnect\x12\x16.rpc.DisconnectRequest\x1a\x17.rpc.DisconnectResponse\"\x000\x01\x122\n" +
	"\x05Proxy\x12\x11.rpc.ProxyRequest\x1a\x12.rpc.ProxyResponse\"\x000\x01\x122\n" +
	"\x05Leave\x12\x11.rpc.LeaveRequest\x1a\x12.rpc.LeaveResponse\"\x000\x01\x122\n" +
	"\x05Clone\x12\x11.rpc.CloneRequest\x1a\x12.rpc.CloneResponse\"\x000\x01\x125\n" +
	"\x06Remove\x12\x12.rpc.RemoveRequest\x1a\x13.rpc.RemoveResponse\"\x000\x01\x12<\n" +
	...
	"\x04Logs\x12\x0f.rpc.LogRequest\x1a\x10.rpc.LogResponse\"\x000\x01\x12-\n" +
	"\x04List\x12\x10.rpc.ListRequest\x1a\x11.rpc.ListResponse\"\x00\x12*\n" +
	"\x03Get\x12\x0f.rpc.GetRequest\x1a\x10.rpc.GetResponse\"\x00\x126\n" +
	...
	"\aVersion\x12\x13.rpc.VersionRequest\x1a\x14.rpc.VersionResponse\"\x00\x122\n" +
	"\x05Reset\x12\x11.rpc.ResetRequest\x1a\x12.rpc.ResetResponse\"\x000\x01\x12>\n" +
	"\tUninstall\x12\x15.rpc.UninstallRequest\x1a\x16.rpc.UninstallResponse\"\x000\x01\x12/\n" +
	"\x04Quit\x12\x10.rpc.QuitRequest\x1a\x11.rpc.QuitResponse\"\x000\x01\x129\n" +
