...
type ConnectRequest struct {
	...
	// Unique owner identifier for TunConfigService IP allocation
	OwnerID string `protobuf:"bytes,15,opt,name=OwnerID,proto3" json:"OwnerID,omitempty"`
	// Connection identifier (namespace UID suffix), generated by user daemon
	ConnectionID string `protobuf:"bytes,16,opt,name=ConnectionID,proto3" json:"ConnectionID,omitempty"`
	// Start a user-daemon-managed local SOCKS5 proxy for this connection (replaces the forked proxy-out subprocess).
	EnableSocks bool `protobuf:"varint,17,opt,name=EnableSocks,proto3" json:"EnableSocks,omitempty"`
	// Listen address for the managed SOCKS5 proxy (default 127.0.0.1:1080).
	SocksListen string `protobuf:"bytes,18,opt,name=SocksListen,proto3" json:"SocksListen,omitempty"`
	// When true the managed proxy dials targets directly from the host (host DNS + network, socks5h egress);
	// when false it resolves cluster Service/Pod and port-forwards (ClusterConnector).
	SocksEgress bool `protobuf:"varint,19,opt,name=SocksEgress,proto3" json:"SocksEgress,omitempty"`
}
...
func (x *ConnectRequest) GetOwnerID() string {
	if x != nil {
		return x.OwnerID
	}
	return ""
...
func (x *ConnectRequest) GetEnableSocks() bool {
	if x != nil {
		return x.EnableSocks
	}
	return false
}

func (x *ConnectRequest) GetSocksListen() string {
	if x != nil {
		return x.SocksListen
	}
	return ""
}

func (x *ConnectRequest) GetSocksEgress() bool {
	if x != nil {
		return x.SocksEgress
	}
	return false
}
...
type DisconnectRequest struct {
	...
	SshJump         *SshJump `protobuf:"bytes,5,opt,name=SshJump,proto3" json:"SshJump,omitempty"`
	// log level controlling what the daemon streams back to the CLI
...
func (x *DisconnectRequest) GetLevel() int32 {
	if x != nil {
		return x.Level
	}
	return 0
...
func (x *LeaveRequest) GetLevel() int32 {
	if x != nil {
		return x.Level
	}
	return 0
...
func (x *UnsyncRequest) GetLevel() int32 {
	if x != nil {
		return x.Level
	}
	return 0
...
func (x *QuitRequest) GetLevel() int32 {
	if x != nil {
		return x.Level
	}
	return 0
...
type Status struct {
	...
	// Listen address of the user-daemon-managed local SOCKS5 proxy, empty if none.
	SocksListenAddr string `protobuf:"bytes,13,opt,name=SocksListenAddr,proto3" json:"SocksListenAddr,omitempty"`
	// Whether the managed SOCKS5 proxy runs in host-direct egress mode (socks5h) vs cluster port-forward mode.
	SocksEgress bool `protobuf:"varint,14,opt,name=SocksEgress,proto3" json:"SocksEgress,omitempty"`
}
...
func (x *Status) GetSocksListenAddr() string {
	if x != nil {
		return x.SocksListenAddr
	}
	return ""
}

func (x *Status) GetSocksEgress() bool {
	if x != nil {
		return x.SocksEgress
	}
	return false
...
func (x *UninstallRequest) GetLevel() int32 {
	if x != nil {
		return x.Level
	}
	return 0
...
func (x *ResetRequest) GetLevel() int32 {
	if x != nil {
		return x.Level
	}
	return 0
...
type TunIPRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	OwnerID    string   `protobuf:"bytes,1,opt,name=OwnerID,proto3" json:"OwnerID,omitempty"`       // sidecar identity (typically podName or nodeID)
	Namespace  string   `protobuf:"bytes,2,opt,name=Namespace,proto3" json:"Namespace,omitempty"`   // workload namespace (for DHCP scoping)
	ExcludeIPs []string `protobuf:"bytes,4,rep,name=ExcludeIPs,proto3" json:"ExcludeIPs,omitempty"` // client local interface IPs to avoid during allocation
	ConfirmIP  string   `protobuf:"bytes,5,opt,name=ConfirmIP,proto3" json:"ConfirmIP,omitempty"`   // client confirms it validated this proposed (dry-run) IP; server commits it
	Hostname   string   `protobuf:"bytes,6,opt,name=Hostname,proto3" json:"Hostname,omitempty"`     // client machine name, recorded in TUN_ALLOCS for debugging (field 3 is a historical gap, do not reuse)
}

func (x *TunIPRequest) Reset() {
	*x = TunIPRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *TunIPRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TunIPRequest) ProtoMessage() {}

func (x *TunIPRequest) ProtoReflect() protoreflect.Message {
	mi := &file_daemon_proto_msgTypes[48]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TunIPRequest.ProtoReflect.Descriptor instead.
func (*TunIPRequest) Descriptor() ([]byte, []int) {
	return file_daemon_proto_rawDescGZIP(), []int{48}
}

func (x *TunIPRequest) GetOwnerID() string {
	if x != nil {
		return x.OwnerID
	}
	return ""
...
func (x *TunIPRequest) GetNamespace() string {
	if x != nil {
		return x.Namespace
	}
	return ""
...
func (x *TunIPRequest) GetExcludeIPs() []string {
	if x != nil {
		return x.ExcludeIPs
	}
	return nil
...
func (x *TunIPRequest) GetConfirmIP() string {
	if x != nil {
		return x.ConfirmIP
	}
	return ""
...
func (x *TunIPRequest) GetHostname() string {
	if x != nil {
		return x.Hostname
	}
	return ""
...
type TunIPResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	IPv4    string `protobuf:"bytes,1,opt,name=IPv4,proto3" json:"IPv4,omitempty"`        // allocated IPv4 in CIDR notation, e.g. "198.18.0.5/32"
	IPv6    string `protobuf:"bytes,2,opt,name=IPv6,proto3" json:"IPv6,omitempty"`        // allocated IPv6 in CIDR notation, e.g. "fd11::5/128"
	Version int64  `protobuf:"varint,3,opt,name=Version,proto3" json:"Version,omitempty"` // monotonically increasing version for change detection
	DryRun  bool   `protobuf:"varint,4,opt,name=DryRun,proto3" json:"DryRun,omitempty"`   // true = a proposal: client must validate locally, then confirm or decline (do NOT apply directly)
}

func (x *TunIPResponse) Reset() {
	*x = TunIPResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *TunIPResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TunIPResponse) ProtoMessage() {}

func (x *TunIPResponse) ProtoReflect() protoreflect.Message {
	mi := &file_daemon_proto_msgTypes[49]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TunIPResponse.ProtoReflect.Descriptor instead.
func (*TunIPResponse) Descriptor() ([]byte, []int) {
	return file_daemon_proto_rawDescGZIP(), []int{49}
}

func (x *TunIPResponse) GetIPv4() string {
	if x != nil {
		return x.IPv4
	}
	return ""
...
func (x *TunIPResponse) GetIPv6() string {
	if x != nil {
		return x.IPv6
	}
	return ""
...
func (x *TunIPResponse) GetVersion() int64 {
	if x != nil {
		return x.Version
	}
	return 0
...
func (x *TunIPResponse) GetDryRun() bool {
	if x != nil {
		return x.DryRun
	}
	return false
...
type NamespaceRoutesRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Namespace string `protobuf:"bytes,1,opt,name=Namespace,proto3" json:"Namespace,omitempty"` // workload namespace the client wants routes/DNS for
}

func (x *NamespaceRoutesRequest) Reset() {
	*x = NamespaceRoutesRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *NamespaceRoutesRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*NamespaceRoutesRequest) ProtoMessage() {}

func (x *NamespaceRoutesRequest) ProtoReflect() protoreflect.Message {
	mi := &file_daemon_proto_msgTypes[50]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use NamespaceRoutesRequest.ProtoReflect.Descriptor instead.
func (*NamespaceRoutesRequest) Descriptor() ([]byte, []int) {
	return file_daemon_proto_rawDescGZIP(), []int{50}
}

func (x *NamespaceRoutesRequest) GetNamespace() string {
	if x != nil {
		return x.Namespace
	}
	return ""
...
// ServiceRecord carries the minimal service fields the client needs for routing
// and DNS/hosts generation (name -> ClusterIP / ExternalName).
type ServiceRecord struct {
	...
	Namespace    string   `protobuf:"bytes,2,opt,name=Namespace,proto3" json:"Namespace,omitempty"`
	ClusterIPs   []string `protobuf:"bytes,3,rep,name=ClusterIPs,proto3" json:"ClusterIPs,omitempty"` // ClusterIP + ClusterIPs (headless "None" filtered client-side)
	ExternalName string   `protobuf:"bytes,4,opt,name=ExternalName,proto3" json:"ExternalName,omitempty"`
}
...
func (x *ServiceRecord) GetNamespace() string {
	if x != nil {
		return x.Namespace
	}
	return ""
...
func (x *ServiceRecord) GetClusterIPs() []string {
	if x != nil {
		return x.ClusterIPs
	}
	return nil
...
func (x *ServiceRecord) GetExternalName() string {
	if x != nil {
...
type NamespaceRoutesResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Snapshot           bool             `protobuf:"varint,1,opt,name=Snapshot,proto3" json:"Snapshot,omitempty"`                    // true = full state (initial / reconnect / resync); false = delta
	AddedPodCIDRs      []string         `protobuf:"bytes,2,rep,name=AddedPodCIDRs,proto3" json:"AddedPodCIDRs,omitempty"`           // pod route prefixes to add (server-aggregated: IPv4 /24, IPv6 /64)
	RemovedPodCIDRs    []string         `protobuf:"bytes,3,rep,name=RemovedPodCIDRs,proto3" json:"RemovedPodCIDRs,omitempty"`       // prefixes no longer backed by any pod (client keeps route, updates state only)
	UpsertedServices   []*ServiceRecord `protobuf:"bytes,4,rep,name=UpsertedServices,proto3" json:"UpsertedServices,omitempty"`     // added/changed services (for DNS)
	RemovedServiceKeys []string         `protobuf:"bytes,5,rep,name=RemovedServiceKeys,proto3" json:"RemovedServiceKeys,omitempty"` // "namespace/name" of deleted services (client removes hosts entry)
	Version            int64            `protobuf:"varint,6,opt,name=Version,proto3" json:"Version,omitempty"`                      // monotonically increasing version for change detection
	Enabled            bool             `protobuf:"varint,7,opt,name=Enabled,proto3" json:"Enabled,omitempty"`                      // false = server not discovering (no RBAC) -> client degrades to CIDR-only
}

func (x *NamespaceRoutesResponse) Reset() {
	*x = NamespaceRoutesResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *NamespaceRoutesResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*NamespaceRoutesResponse) ProtoMessage() {}

func (x *NamespaceRoutesResponse) ProtoReflect() protoreflect.Message {
	mi := &file_daemon_proto_msgTypes[52]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use NamespaceRoutesResponse.ProtoReflect.Descriptor instead.
func (*NamespaceRoutesResponse) Descriptor() ([]byte, []int) {
	return file_daemon_proto_rawDescGZIP(), []int{52}
}

func (x *NamespaceRoutesResponse) GetSnapshot() bool {
	if x != nil {
		return x.Snapshot
	}
	return false
...
func (x *NamespaceRoutesResponse) GetAddedPodCIDRs() []string {
	if x != nil {
		return x.AddedPodCIDRs
	}
	return nil
}

func (x *NamespaceRoutesResponse) GetRemovedPodCIDRs() []string {
	if x != nil {
		return x.RemovedPodCIDRs
	}
	return nil
}

func (x *NamespaceRoutesResponse) GetUpsertedServices() []*ServiceRecord {
	if x != nil {
		return x.UpsertedServices
	}
	return nil
}

func (x *NamespaceRoutesResponse) GetRemovedServiceKeys() []string {
	if x != nil {
		return x.RemovedServiceKeys
	}
	return nil
}

func (x *NamespaceRoutesResponse) GetVersion() int64 {
	if x != nil {
		return x.Version
	}
	return 0
...
func (x *NamespaceRoutesResponse) GetEnabled() bool {
	if x != nil {
		return x.Enabled
	}
	return false
...
var file_daemon_proto_rawDesc = []byte{
	...
	0x72, 0x70, 0x63, 0x22, 0xd9, 0x04, 0x0a, 0x0e, 0x43, 0x6f, 0x6e, 0x6e, 0x65, 0x63, 0x74, 0x52,
	...
	,
	...
	0x75, 0x6d, 0x70, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0c, 0x2e, 0x72, 0x70, 0x63, 0x2e,
	0x53, 0x73, 0x68, 0x4a, 0x75, 0x6d, 0x70, 0x52, 0x07, 0x53, 0x73, 0x68, 0x4a, 0x75, 0x6d, 0x70,
	0x12, 0x14, 0x0a, 0x05, 0x4c, 0x65, 0x76, 0x65, 0x6c, 0x18, 0x06, 0x20, 0x01, 0x28, 0x05, 0x52,
	0x05, 0x4c, 0x65, 0x76, 0x65, 0x6c, 0x42, 0x0f, 0x0a, 0x0d, 0x5f, 0x43, 0x6f, 0x6e, 0x6e, 0x65,
	0x63, 0x74, 0x69, 0x6f, 0x6e, 0x49, 0x44, 0x42, 0x06, 0x0a, 0x04, 0x5f, 0x41, 0x6c, 0x6c, 0x42,
	...
	0x65, 0x22, 0xe1, 0x04, 0x0a, 0x0c, 0x50, 0x72, 0x6f, 0x78, 0x79, 0x52, 0x65, 0x71, 0x75, 0x65,
	...
	,
	...
	,
	...
	0x22, 0x60, 0x0a, 0x0c, 0x4c, 0x65, 0x61, 0x76, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	...
	0x0a, 0x09, 0x57, 0x6f, 0x72, 0x6b, 0x6c, 0x6f, 0x61, 0x64, 0x73, 0x18, 0x02, 0x20, 0x03, 0x28,
	0x09, 0x52, 0x09, 0x57, 0x6f, 0x72, 0x6b, 0x6c, 0x6f, 0x61, 0x64, 0x73, 0x12, 0x14, 0x0a, 0x05,
	0x4c, 0x65, 0x76, 0x65, 0x6c, 0x18, 0x03, 0x20, 0x01, 0x28, 0x05, 0x52, 0x05, 0x4c, 0x65, 0x76,
	0x65, 0x6c, 0x22, 0x29, 0x0a, 0x0d, 0x4c, 0x65, 0x61, 0x76, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f,
	0x6e, 0x73, 0x65, 0x12, 0x18, 0x0a, 0x07, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0xff, 0x04,
	...
	0x73, 0x70, 0x61, 0x63, 0x65, 0x12, 0x37, 0x0a, 0x07, 0x48, 0x65, 0x61, 0x64, 0x65, 0x72, 0x73,
	0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1d, 0x2e, 0x72, 0x70, 0x63, 0x2e, 0x53, 0x79, 0x6e,
	0x63, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x2e, 0x48, 0x65, 0x61, 0x64, 0x65, 0x72, 0x73,
	0x45, 0x6e, 0x74, 0x72, 0x79, 0x52, 0x07, 0x48, 0x65, 0x61, 0x64, 0x65, 0x72, 0x73, 0x12, 0x1c,
	0x0a, 0x09, 0x57, 0x6f, 0x72, 0x6b, 0x6c, 0x6f, 0x61, 0x64, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28,
	0x09, 0x52, 0x09, 0x57, 0x6f, 0x72, 0x6b, 0x6c, 0x6f, 0x61, 0x64, 0x73, 0x12, 0x2f, 0x0a, 0x0a,
	...
	,
	...
	0x75, 0x62, 0x65, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x50, 0x61, 0x74, 0x68, 0x18, 0x13, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x14, 0x4f, 0x72, 0x69, 0x67, 0x69, 0x6e, 0x4b, 0x75, 0x62, 0x65, 0x63,
	0x6f, 0x6e, 0x66, 0x69, 0x67, 0x50, 0x61, 0x74, 0x68, 0x12, 0x1a, 0x0a, 0x08, 0x4c, 0x6f, 0x63,
	0x61, 0x6c, 0x44, 0x69, 0x72, 0x18, 0x14, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x4c, 0x6f, 0x63,
	0x61, 0x6c, 0x44, 0x69, 0x72, 0x12, 0x1c, 0x0a, 0x09, 0x52, 0x65, 0x6d, 0x6f, 0x74, 0x65, 0x44,
	0x69, 0x72, 0x18, 0x15, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x52, 0x65, 0x6d, 0x6f, 0x74, 0x65,
	0x44, 0x69, 0x72, 0x1a, 0x3a, 0x0a, 0x0c, 0x48, 0x65, 0x61, 0x64, 0x65, 0x72, 0x73, 0x45, 0x6e,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x64, 0x55, 0x70, 0x67, 0x72, 0x61, 0x64, 0x65, 0x22, 0x98, 0x01, 0x0a, 0x10, 0x55, 0x6e, 0x69,
	...
	0x4a, 0x75, 0x6d, 0x70, 0x52, 0x07, 0x53, 0x73, 0x68, 0x4a, 0x75, 0x6d, 0x70, 0x12, 0x14, 0x0a,
	0x05, 0x4c, 0x65, 0x76, 0x65, 0x6c, 0x18, 0x04, 0x20, 0x01, 0x28, 0x05, 0x52, 0x05, 0x4c, 0x65,
	0x76, 0x65, 0x6c, 0x22, 0x2d, 0x0a, 0x11, 0x55, 0x6e, 0x69, 0x6e, 0x73, 0x74, 0x61, 0x6c, 0x6c,
	...
	,
	...
	,
	...
	0x61, 0x63, 0x65, 0x22, 0x85, 0x01, 0x0a, 0x0d, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x52,
	...
	,
	...
	,
	...
	,
	...
	0x65, 0x22, 0x00, 0x12, 0x30, 0x0a, 0x05, 0x52, 0x6f, 0x75, 0x74, 0x65, 0x12, 0x11, 0x2e, 0x72,
	0x70, 0x63, 0x2e, 0x52, 0x6f, 0x75, 0x74, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a,
	0x12, 0x2e, 0x72, 0x70, 0x63, 0x2e, 0x52, 0x6f, 0x75, 0x74, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f,
	0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x2f, 0x0a, 0x04, 0x4c, 0x6f, 0x67, 0x73, 0x12, 0x0f, 0x2e,
	0x72, 0x70, 0x63, 0x2e, 0x4c, 0x6f, 0x67, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x10,
	0x2e, 0x72, 0x70, 0x63, 0x2e, 0x4c, 0x6f, 0x67, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65,
	0x22, 0x00, 0x28, 0x01, 0x30, 0x01, 0x12, 0x36, 0x0a, 0x07, 0x55, 0x70, 0x67, 0x72, 0x61, 0x64,
	...
	0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x34, 0x0a, 0x05, 0x52,
	...
	0x73, 0x65, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x28, 0x01, 0x30,
	0x01, 0x12, 0x40, 0x0a, 0x09, 0x55, 0x6e, 0x69, 0x6e, 0x73, 0x74, 0x61, 0x6c, 0x6c, 0x12, 0x15,
	0x2e, 0x72, 0x70, 0x63, 0x2e, 0x55, 0x6e, 0x69, 0x6e, 0x73, 0x74, 0x61, 0x6c, 0x6c, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x16, 0x2e, 0x72, 0x70, 0x63, 0x2e, 0x55, 0x6e, 0x69, 0x6e,
	0x73, 0x74, 0x61, 0x6c, 0x6c, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x28,
	0x01, 0x30, 0x01, 0x12, 0x31, 0x0a, 0x04, 0x51, 0x75, 0x69, 0x74, 0x12, 0x10, 0x2e, 0x72, 0x70,
	...
	,
...
var file_daemon_proto_goTypes = []interface{}{
	...
	(*TunIPRequest)(nil),            // 49: rpc.TunIPRequest
	(*TunIPResponse)(nil),           // 50: rpc.TunIPResponse
...
func file_daemon_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_daemon_proto_msgTypes[50].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*NamespaceRoutesRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_daemon_proto_msgTypes[52].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*NamespaceRoutesResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
